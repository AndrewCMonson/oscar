...
const config: CodegenConfig = {
  ...
  config: {
    ...
    mappers: {
      ...
      ProjectContext:
        "@prisma/client/index.d#ProjectContext as ProjectContextModel",
      ProjectMetadata:
        "@prisma/client/index.d#ProjectMetadata as ProjectMetadataModel",
      ProjectGoal: "@prisma/client/index.d#ProjectGoal as ProjectGoalModel",
      ProjectPreferences:
        "@prisma/client/index.d#ProjectPreferences as ProjectPreferencesModel",
      Assistant: "@prisma/client/index.d#Assistant as AssistantModel",
      GlobalContext:
        "@prisma/client/index.d#GlobalContext as GlobalContextModel",
      GlobalContextMessage:
        "@prisma/client/index.d#GlobalContextMessage as GlobalContextMessageModel",
      Task: "@prisma/client/index.d#Task as TaskModel",
      Message: "@prisma/client/index.d#Message as MessageModel",
      UserPreferences:
        "@prisma/client/index.d#UserPreferences as UserPreferencesModel",
      UserIntegration:
        "@prisma/client/index.d#UserIntegration as UserIntegrationsModel",
      NotificationSettings:
        "@prisma/client/index.d#NotificationSettings as NotificationSettingsModel",
      ...
      AssistantResponse:
        "@prisma/client/index.d#AssistantResponse as AssistantResponseModel",
    },
  },
};
