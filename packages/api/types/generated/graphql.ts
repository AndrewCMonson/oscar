...
export type ResolversTypes = ResolversObject<{
  ...
  Conversation: ResolverTypeWrapper<Omit<Conversation, 'messages' | 'project' | 'user'> & { messages?: Maybe<Array<Maybe<ResolversTypes['Message']>>>, project?: Maybe<ResolversTypes['Project']>, user?: Maybe<ResolversTypes['User']> }>;
...
export type ResolversParentTypes = ResolversObject<{
  ...
  Conversation: Omit<Conversation, 'messages' | 'project' | 'user'> & { messages?: Maybe<Array<Maybe<ResolversParentTypes['Message']>>>, project?: Maybe<ResolversParentTypes['Project']>, user?: Maybe<ResolversParentTypes['User']> };
