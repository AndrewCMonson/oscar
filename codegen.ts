...
const config: CodegenConfig = {
  ...
  config: {
    ...
    mappers: {
      ...
      Project:
        "./packages/api/node_modules/@prisma/client/index.d#Project as ProjectModel",
      ProjectContext:
      ...
      Assistant:
        "./packages/api/node_modules/@prisma/client/index.d#Assistant as AssistantModel",
      GlobalContext:
      ...
      Message:
        "./packages/api/node_modules/@prisma/client/index.d#Message as MessageModel",
      UserPreferences:
      ...
      UserMemory:
        "./packages/api/node_modules/@prisma/client/index.d#UserMemory as UserMemoryModel",
      Memory:
        "./packages/api/node_modules/@prisma/client/index.d#Memory as MemoryModel",
      Conversation:
        "./packages/api/node_modules/@prisma/client/index.d#Conversation as ConversationModel",
      AssistantResponse:
